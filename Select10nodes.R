...
level1_10nodes <- filter(level1_mass,foodweb%in%num1)
level1_10nodes <- filter(level1_10nodes,mass>8.0e-04)

num2 <- vector()
for(i in 1:282){
  if(sum(level2_mass[,1]==i+397)>=10){
    num2 <- c(num2,i+397)
  }else{
    num2 <- num2
  }
...
num2
length(num2) #249
level2_10nodes <- filter(level2_mass,foodweb%in%num2)
level2_10nodes <- filter(level2_10nodes,mass>8.0e-04)

num3 <- vector()
for(i in 1:186){
  if(sum(level3_mass[,1]==i+679)>=10){
    num3 <- c(num3,i+679)
  }else{
    num3 <- num3
  }
...
num3
length(num3) #132
level3_10nodes <- filter(level3_mass,foodweb%in%num3)
level3_10nodes <- filter(level3_10nodes,mass>8.0e-04)

save(level1_10nodes,level2_10nodes,level3_10nodes,file='research_10nodes.RData')
